                ...
                <div className="accordion" id="accordionExample">
                    <div className="accordion-item">
                        ...
                        <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                ...
                                <p className='fw-bold mb-1 title ms-3'>Features:</p>
                                <ul>
                    ...
                    <div className="accordion-item">
                        ...
                        <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div className="accordion-body">
                                ...
                                <span className='ms-4 fw-bold title'>Working procedures:</span>
                    ...
                    <div className="accordion-item">
                        ...
                        <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <p className='mt-2 ms-3'>The useRef hook accepts one argument as the initial value and returns a reference object which is mutable and it is known as current. The useRef hook can be used to store a mutable value that does not cause a re-render when updated</p>
                            <span className='fw-bold ms-3 title'>Syntax</span>
                            <p className='ms-3 '>const refContainer = useRef(initialValue);</p>
                            <p className='ms-3 '>Firstly, we set the initial value: useRef(0). It is same as: </p>
                            <img className='img-fluid ms-3' src={'/useRef.png'} alt="useRef" />
                            <p className='ms-3 mt-2'>We can access the count using count.current.</p>
                        </div>
                    </div>
                </div>
            </div>
